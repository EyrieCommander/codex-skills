...
description: Use when the user asks to pressure-test a startup idea, validate whether a problem is real, map competitors and current behavior, find the first 10 customers, define an MVP, create a 2-week launch plan, assess founder-market fit, or get a direct strong/weak/pivot verdict.
---
